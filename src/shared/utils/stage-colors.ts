...
const STAGE_COLOR_MAP: Record<StageColor, StageColorClasses> = {
  gray: {
    ...
    border: 'border-zinc-600 contrast-more:border-white',
  },
  blue: {
    bg: 'bg-blue-900/60 contrast-more:bg-blue-900',
    text: 'text-blue-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-blue-600 contrast-more:border-white',
  },
  cyan: {
    bg: 'bg-cyan-900/60 contrast-more:bg-cyan-900',
    text: 'text-cyan-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-cyan-600 contrast-more:border-white',
  },
  yellow: {
    bg: 'bg-yellow-900/60 contrast-more:bg-yellow-900',
    text: 'text-yellow-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-yellow-600 contrast-more:border-white',
  },
  orange: {
    bg: 'bg-orange-900/60 contrast-more:bg-orange-900',
    text: 'text-orange-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-orange-600 contrast-more:border-white',
  },
  green: {
    bg: 'bg-green-900/60 contrast-more:bg-green-900',
    text: 'text-green-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-green-600 contrast-more:border-white',
  },
  purple: {
    bg: 'bg-purple-900/60 contrast-more:bg-purple-900',
    text: 'text-purple-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-purple-600 contrast-more:border-white',
  },
  pink: {
    bg: 'bg-pink-900/60 contrast-more:bg-pink-900',
    text: 'text-pink-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-pink-600 contrast-more:border-white',
  },
  red: {
    bg: 'bg-red-900/60 contrast-more:bg-red-900',
    text: 'text-red-200 contrast-more:text-white contrast-more:font-bold',
    border: 'border-red-600 contrast-more:border-white',
  },
} as const
