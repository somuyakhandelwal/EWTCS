...
export function VirtualBedsSection({
    ...
    return (
        <div className="rounded-lg border border-status-virtual/30 bg-status-virtual/5 p-4 space-y-3">
            <div className="flex items-center justify-between">
                <h2 className="flex items-center gap-2 text-sm font-semibold text-status-virtual uppercase tracking-wider">
                    <MapPin className="h-4 w-4" />
                    Hallway / Stretchers
                    {virtualBeds.length > 0 && (
                        <span className="ml-1 rounded-full bg-status-virtual/20 px-2 py-0.5 text-[10px] font-bold">
                ...
                {onAddVirtualBed && (
                    <Button
                        ...
                        className="bg-status-virtual hover:bg-status-virtual/90 text-primary-foreground border-none h-8 text-xs font-semibold"
                    >
