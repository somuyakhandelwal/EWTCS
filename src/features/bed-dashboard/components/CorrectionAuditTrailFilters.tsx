    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
            <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Bed Number</Label>
                <Input
            ...
            <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Correction Reason</Label>
                <Input
            ...
            <Button
                ...
                disabled={loading}
                className="bg-amber-600 hover:bg-amber-500 text-foreground gap-2 h-9"
            >
