...
// Re-exports for backward compatibility — batch utilities moved to field-encryptor-batch.ts
export { encryptFieldsBatch, decryptFieldsBatch, isEncryptedField } from './field-encryptor-batch'
